...
<head>
    ...
    <title>Abhi Journal | Admin</title>
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="">Abhi Journal</a>
        <button
    ...
    <div>
        <a href="https://www.instagram.com/Abhiraaaaa_"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6281331274819"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Abhirama Maulana Putra &copy; 2023</div>
    </footer>
    <!-- footer end -->
    <script
